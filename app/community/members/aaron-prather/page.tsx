            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <div className="mb-8">
                ...
                <p className="text-[#747474] leading-relaxed">
                  Leads ASTM efforts in the field of Robotics and Autonomous
                  Systems. From Standards Development to Workforce Training to
                  R&D, ASTM has a lot of tools to offer.
                </p>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  <Badge
                    variant="outline"
                    className="bg-[#e8f3ff] text-[#222222] border-[#aabbcc]"
                  >
                    Automation
                  </Badge>
                  <Badge
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 className="text-lg font-bold text-[#222222] mb-3">
                    Membership Level
                  </h4>
                  <Badge
                    variant="outline"
                    className="bg-[#ffe9bc] text-[#222222] border-[#ffb621]"
                  >
                    Supporting
                  </Badge>
                </div>
                ...
                <div>
                  ...
                  <Badge
                    variant="outline"
                    className="bg-[#ddf9e2] text-[#222222] border-[#3a8941]"
                  >
